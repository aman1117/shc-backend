...
func NewDbService() *DbService {
	DBURL := fmt.Sprintf("host=%s port=%s user=%s dbname=%s sslmode=disable password=%s", os.Getenv("DB_HOST"), os.Getenv("DB_PORT"), os.Getenv("DB_USER2"), os.Getenv("DB_NAME"), os.Getenv("DB_PASSWORD2"))
